...
Route::get('captcha/[:id]', "\\think5\\captcha\\CaptchaController@index");
...
{
    $captcha = new \think5\captcha\Captcha($config);
...
{
    $captcha = new \think5\captcha\Captcha((array) Config::pull('captcha'));
